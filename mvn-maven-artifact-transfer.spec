...
License  : Apache-2.0
Requires: mvn-maven-artifact-transfer-data = %{version}-%{release}

%description
No detailed description available

%package data
Summary: data components for the mvn-maven-artifact-transfer package.
Group: Data

%description data
data components for the mvn-maven-artifact-transfer package.
